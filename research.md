...
<div style="display: flex; justify-content: space-between; width: 80%; margin: 0 auto; gap: 30px; align-items: stretch; padding-top:0;">
  ...
  <!-- Panel 2: Slider (55%) -->
  <figure style="flex: 0 0 55%; display: flex; flex-direction: column; justify-content: flex-start; align-items: center; text-align: center; margin: 0; border: 1px solid #ccc; border-radius: 5px; padding: 5px; box-sizing: border-box;">
    ...
    <!-- Caption -->
    <figcaption style="font-size: 0.9em; font-style: italic; line-height: 1.3; margin-top: -5px; margin-bottom: 0; padding: 0;">
      Visualization of Jacaranda bloom with the Flower Color Index (FCI)-Purple applied to RGB imagery.
    </figcaption>
