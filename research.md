...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; align-items: flex-start;">
  ...
  <!-- Left column: Study area figure -->
  <figure style="flex: 1 1 400px; max-width: 500px; text-align: center; margin: 0;">
    ...
    <figcaption style="font-size: 0.9em; font-style: italic; line-height: 1.3; margin-top: 8px;">
      Geographic distribution of study areas spanning the Northern and Southern Hemispheres, including multiple species and flower spectra used to evaluate the Flower Color Index.
    </figcaption>
  </figure>
